...
import cn.lannie.kt.blockchain.core.sqlite.config.identiry.SQLiteDialectIdentityColumnSupport
...
class SQLiteDialect : Dialect() {
  ...
  */
	...
	public String getCastTypeName(int code) {
        ...
        private val IDENTITY_COLUMN_SUPPORT = SQLiteDialectIdentityColumnSupport(SQLiteDialect())
